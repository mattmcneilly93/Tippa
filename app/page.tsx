    ...
    <main className="page-shell">
      <section className="relative flex min-h-[calc(100vh-5rem)] flex-col items-center justify-center gap-8 overflow-hidden py-8 text-center">
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-6 px-4">
          <h1 className="w-full bg-gradient-to-r from-[#002fa7] via-[#2f6bff] to-[#7db4ff] bg-clip-text text-[clamp(2.5rem,10vw,8rem)] font-black leading-[0.9] tracking-tight text-transparent drop-shadow-lg">
            mmmmundial
          </h1>
          <p className="max-w-md text-base font-semibold text-white drop-shadow-md sm:text-lg">
